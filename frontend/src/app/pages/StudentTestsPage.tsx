      ...
      <div className="min-h-screen bg-gray-50 pt-20">
        <div className="container mx-auto px-4 py-8">
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-600">Выберите тест для прохождения</p>
          </div>
          ...
          {availableTests.length > 0 ? (
                ...
                <div key={test.id} className="bg-white rounded-lg shadow-md p-6 border-l-4 border-orange-500">
                  ...
                  <div className="grid grid-cols-2 gap-4 mb-6 text-sm">
                    ...
                    <div className="flex items-center">
                      ...
                      <span className="ml-2 font-semibold text-gray-900">{test.timeLimit || test.time_limit || 30} мин</span>
                    </div>
                    <div>
                    ...
                    <div>
                      ...
                      <span className="ml-2 font-semibold text-gray-900">
                        {(test.attemptsTotal || test.attempts_total || 3) - (test.attemptsUsed || test.attempts_used || 0)} из {test.attemptsTotal || test.attempts_total || 3}
                      </span>
                    </div>
                  </div>
            ...
            <div className="text-center py-12 bg-white rounded-lg shadow-md">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-2">Нет доступных тестов</h3>
              <p className="text-gray-600 mb-4">На данный момент нет тестов для прохождения</p>
              <Link
                to="/student/dashboard"
